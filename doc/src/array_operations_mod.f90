module array_operations_mod
   ...
   !---------------------------------------------------------------------------!
!   interface print_square_matrix
!      module subroutine print_square_matrix_int32(matrix_, tol_)
!         !! print elements of the square matrix with given tolerance (integer version)
!         integer(int32), intent(in)     :: matrix_(:,:)
!         real(dp), optional, intent(in) :: tol_
!      end subroutine print_square_matrix_int32
!      module subroutine print_square_matrix_sp(matrix_, tol_)
!         !! print elements of the square matrix with given tolerance (single precision version)
!         real(sp), intent(in)           :: matrix_(:,:)
!         real(dp), optional, intent(in) :: tol_
!      end subroutine print_square_matrix_sp
!      module subroutine print_square_matrix_dp(matrix_, tol_)
!         !! print elements of the square matrix with given tolerance (double precision version)
!         real(dp), intent(in)           :: matrix_(:,:)
!         real(dp), optional, intent(in) :: tol_
!      end subroutine print_square_matrix_dp
!   end interface
   !---------------------------------------------------------------------------!
